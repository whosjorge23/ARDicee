...
//  ARDicee
//
//  Created by Jorge Giannotta on 03/04/2019.
...
//             Create a new scene
    ...
    @IBAction func rollAgainButton(_ sender: UIBarButtonItem) {
    ...
    @IBAction func removeAllDiceButton(_ sender: UIBarButtonItem) {
